...
# <stringAttribute key="org.eclipse.jdt.launching.PROGRAM_ARGUMENTS" value="-war target/daris-portal-1.0.2  -noserver -nostartServer -nosuperDevMode -codeServerPort 9997 -startupUrl DaRIS.html daris.DaRIS"/>