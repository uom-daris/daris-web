...
public class TextTypeFormItem implements FormItem {
    ...
    protected static Widget createWidgetFor(final Form form, final Field f, final FormItemFocusListener fl,
            final int minLength, final int maxLength, int height) {
    ...
    private static Widget createDefaultWidgetFor(final Form form, final Field f, final FormItemFocusListener fl,
            final int minLength, final int maxLength, int height) {
    ...
    private static Widget createAutoResizeWidgetFor(final Form form, final Field f, final FormItemFocusListener fl,
            final int minLength, final int maxLength, int height) {
    ...
    private static void performCommonInitialization(final TextWidget<com.google.gwt.user.client.ui.TextArea> text,
            final Form form, final Field f, final FormItemFocusListener fl, final int minLength, final int maxLength,
            int height) {
            ...
            public void onValueChange(ValueChangeEvent<String> event) {
                ...
                if (v == null || v.equals("")) {
                    ...
                    if (v.length() < minLength) {
                        f.markInvalid("The minimum length must be " + minLength + " character(s). The value is "
                                + v.length() + " character(s).");
                    }
                }
            }
        });
