...
public class HorizontalSplitPanel extends ContainerWidget {
    ...
    public static final Image HANDLE_BACKGROUND = new LinearGradient(LinearGradient.Orientation.LEFT_TO_RIGHT,
            new Colour[] { RGB.GREY_AAA, RGB.GREY_EEE, RGB.GREY_AAA });

    // public static final Image HANDLE_GRIP = new
    // Image("resources/images/panel/HorizontalSplitHandle.png",2,6);

    static {
        Style s = StyleRegistry.register(HorizontalSplitPanel.class);

        s.relate(StyleRegistry.register(Separator.class).setBackgroundImage(HANDLE_BACKGROUND)
                .setBackgroundColour(RGB.GREY_DDD).setBorderLeft(1, BorderStyle.SOLID, RGB.GREY_AAA)
                .setBorderRight(1, BorderStyle.SOLID, RGB.GREY_999).setCursor(Cursor.COL_RESIZE));
    }
    ...
    private class Content extends SimplePanel {
        ...
        /*
         * protected void resized() { if ( !readyToResize() ) { return; }
         * 
         * Widget widget = widget(); if ( widget instanceof BaseWidget ) {
         * (BaseWidget)bw. } if ( widget instanceof CanBeResized ) {
         * CanBeResized cbr = (CanBeResized)widget; cbr.resizeTo(width(),
         * height()); } }
         */
    }
    ...
    protected static class Separator extends SimplePanel {
        ...
        public Separator(final HorizontalSplitPanel sp, final Content a, final Content b) {
            ...
            super.setPosition(Position.ABSOLUTE);
            // super.setZIndex(Integer.MAX_VALUE);
            ...
            DragAndDrop.makeDraggable(new MoveDragSource() {
                public Cursor beginDrag(int x, int y) {
                    ...
                    Separator.this.element().getStyle().setZIndex(Integer.MAX_VALUE);
                ...
                public void endDrag() {
                    ...
                    Separator.this.element().getStyle().clearZIndex();
                }
        ...
        /*
         * public int absoluteLeft() { return _x; }
         */
        ...
        public void setRightWidgetVisible(boolean visible) {
            ...
            if (visible) {
                ...
                // Remove the width of the right panel from the left if making
                // the right visible.
                _aw -= _bw;
            } else {
                _tw = _aw + _bw + _separatorWidth;
    ...
    /*
     * public boolean resizeNeighbour() { return _resizeNeighbour; }
     */

    /**
     * Controls whether resizing one panel causes the next panel to resize. By
     * default resizing one panel, will change the size of the neighbour.
     * 
     * @param cascade
     */
    /*
     * public void setResizeNeighbour(boolean resize) { _resizeNeighbour =
     * resize; }
     */
    ...
    public void setPanelVisible(int i, boolean visible) {
        ...
        // If already layed out then we an perform immediately, otherwise we
        // need to defer until after the
        ...
        if (_initial) {
            ...
            if (i == _ss.size()) {
                // Find the i'th separator, and tell it to set the top level
                // widget height to that.
    ...
    protected void doLayoutChildren() {
        ...
        // We must set the width to allow scrolling adjustments. We know the
        // width now
        ...
        if (_nonVisible != null) {
            ...
            // Set to null to avoid a stack overflow, because changing the panel
            // visibility will cause a
