...
public class ExMethodStepRef extends ObjectRef<ExMethodStep> {
    ...
    protected ExMethodStep instantiate(XmlElement xe) throws Throwable {
        ...
        if (xe != null && xe.element("ex-method") != null) {
            ...
            if (xe.element("ex-method/step/study") != null) {
                ...
                return new ExMethodStudyStep(_exMethodId, _exMethodProute, _stepPath, name,
                        state == null ? null : State.fromString(state), notes, studyType, meta, true);
            } else if (xe.element("ex-method/step/subject") != null) {
                XmlElement psMetaEditable = xe.element("ex-method/step/subject[@type='p']");
                XmlElement rsMetaEditable = xe.element("ex-method/step/subject[@type='r']");
                return new ExMethodSubjectStep(_exMethodId, _exMethodProute, _stepPath, name,
                        state == null ? null : State.fromString(state), notes, psMetaEditable, rsMetaEditable, true);
            } else if (xe.element("ex-method/step/transform") != null) {
                throw new Exception("Not implemented.");
            }
        }
        throw new Exception("Invalid ex-method step: " + xe);
    }
