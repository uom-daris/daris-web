...
public class ProjectUser implements Comparable<ProjectUser> {
    ...
    public ProjectUser(XmlElement me) {
        ...
        DomainRef domain = new DomainRef(authority, me.value("@domain"), Domain.Type.LOCAL, null);
    ...
    public boolean equals(Object o) {
        ...
        ProjectUser pm = (ProjectUser) o;
        return _user.equals(pm.user()) && _role.equals(pm.role()) && ObjectUtil.equals(_dataUse, pm.dataUse());
    }

    public boolean isSameUser(ProjectUser pm) {
