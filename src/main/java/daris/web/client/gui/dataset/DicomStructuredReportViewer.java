...
import daris.web.client.model.dataset.sr.StructuredReport;
import daris.web.client.model.dataset.sr.StructuredReportRef;
import daris.web.client.model.dataset.sr.tree.SRTree;

public class DicomStructuredReportViewer extends ContainerWidget {
