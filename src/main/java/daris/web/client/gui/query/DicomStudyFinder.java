...
public class DicomStudyFinder {
    ...
    public DicomStudyFinder() {
        ...
        _queryForm = new QuerySettingsForm("model='om.pssd.study' and mf-dicom-study has value") {
        ...
        _searchButton = ButtonUtil.createButton(ICON_SEARCH, "Search", "Search for DICOM studies", true);
    ...
    protected void initializeQuery(DObjectQueryResultCollectionRef rc) {
        rc.addXPath("mf-dicom-study/sdate", "scan-date");
    ...
    protected void addFilterItems(FilterForm form) {
        ...
        form.add(new DateFilterFieldGroup("mf-dicom-study/sdate", "scan date", "Scan date"));
        form.add(new DateFilterFieldGroup("mf-dicom-study/ingest/date", "ingest date",
